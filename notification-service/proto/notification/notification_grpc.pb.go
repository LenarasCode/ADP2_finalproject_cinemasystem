...
func (c *notificationServiceClient) GetEmailLogs(ctx context.Context, in *GetEmailLogsRequest, opts ...grpc.CallOption) (*GetEmailLogsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedNotificationServiceServer) GetEmailLogs(context.Context, *GetEmailLogsRequest) (*GetEmailLogsResponse, error) {
...
func _NotificationService_GetEmailLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetEmailLogs(ctx, req.(*GetEmailLogsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
